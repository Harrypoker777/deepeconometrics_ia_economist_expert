  ...
  return (
    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-border bg-background p-5">
        ...
        <div className="mt-5 flex flex-col items-center rounded-xl border border-border bg-secondary/50 px-6 py-7 text-center">
        ...
        <div className="mt-4 rounded-xl border border-dashed border-border bg-secondary/30 px-5 py-5">
